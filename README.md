...
C-Eyes 是一款基于 Go 语言的终端安全检测与响应工具（EDR系统），有别于其它大型EDR系统，该工具的设计目标是轻量化，使用简单，功能齐全。其中围绕“资产盘点、风险识别、溯源分析、基线检查”提供一体化能力：可进行主机与文件信息采集、异常与风险分析、主机日志检索、内网资产探测、SBOM 软件物料清单生成、安全基线检查，帮助安全团队更高效地完成从发现到处置的闭环工作。 
