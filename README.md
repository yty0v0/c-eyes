...
C-Eyes（Cyber Eye）是一款基于 Go 的终端安全检测与响应（EDR）命令行工具，围绕“资产盘点、风险识别、溯源分析”提供一体化能力：可进行主机与文件信息采集、异常与风险分析、主机日志检索、内网资产探测 以及 SBOM 软件物料清单生成，帮助安全团队更高效地完成从发现到处置的闭环工作。 

![C-Eyes 工具简介图](./docs/images/c-eyes.png)
