...
Define the unified `c-eyes eventlog` host log collection behavior, including collection-only boundaries, cross-platform normalization, deterministic filtering/sorting/pagination, and safe optional raw payload handling.
