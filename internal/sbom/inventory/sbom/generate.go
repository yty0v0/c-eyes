...
import (
	...
	"edrsystem/internal/sbom/inventory/artifact"
	"edrsystem/internal/sbom/inventory/pckg"
	"edrsystem/internal/sbom/inventory/pckg/collector/deb"
	"edrsystem/internal/sbom/inventory/pckg/collector/rpm"
	"edrsystem/internal/sbom/inventory/source"
	"edrsystem/internal/sbom/model"
	"edrsystem/internal/sbom/spec"
	"edrsystem/internal/sbom/spec/format/xspdx"
...
func GenerateSBOM(cfg *config.GenerateConfig) (*model.SBOM, error) {
	...
	// Populate artifact license from the root package when artifact license is empty.
